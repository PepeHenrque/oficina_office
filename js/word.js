...
const WordModule = {
  ...
  tasks: [
    ...
    { id:'w11', title:'🏆 Desafio Final: Relatório Executivo', xp:100,
      explanation:'<p><strong>Você é o estagiário responsável pelo relatório anual.</strong> Complete os 4 requisitos abaixo, na ordem que quiser:</p><ol style="margin:0 0 0 18px;padding:0;list-style:decimal;"><li>Deixe o título em <strong>negrito</strong>.</li><li><strong>Justifique</strong> o alinhamento do parágrafo.</li><li><strong>Insira uma tabela</strong> em qualquer lugar do documento.</li><li>Troque <code>[STATUS]</code> por <code>Aprovado</code>.</li></ol>',
