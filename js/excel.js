...
const ExcelModule = {
  ...
  tasks: [
    ...
    { id:'e11', title:'🏆 Desafio Final: DRE Financeiro', xp:100,
      explanation:'<p><strong>Você está fechando o Demonstrativo de Resultado do trimestre.</strong> Preencha a receita de Março com <code>5000</code> na célula <strong>D2</strong> e calcule o TOTAL da receita em <strong>E2</strong> com <code>=SOMA(B2:D2)</code>.</p>',
      hint: 'D2: 5000  |  E2: =SOMA(B2:D2) — o checklist ao lado mostra exatamente qual das duas ainda falta.',
