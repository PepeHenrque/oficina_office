...
const PPTModule = {
  ...
  tasks: [
    ...
    { id:'p11', title:'🏆 Desafio Final: Pitch de Vendas', xp:100,
      explanation:'<p><strong>Você vai apresentar para um cliente em potencial.</strong> Complete os 4 requisitos abaixo, na ordem que quiser:</p><ol style="margin:0 0 0 18px;padding:0;list-style:decimal;"><li>Tenha pelo menos <strong>2 slides</strong> no total.</li><li>Aplique o <strong>Tema Azul</strong>.</li><li>Adicione pelo menos <strong>1 cartão visual</strong> em algum slide.</li><li>Mude o título do primeiro slide para <code>Pitch de Vendas</code>.</li></ol>',
