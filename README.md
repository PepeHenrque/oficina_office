...
├── files/               # os 3 cadernos de atividades reais (.docx/.xlsx/.pptx),
│                         # linkados na aba "Baixar Arquivos" do app
└── js/
    ├── data-state.js    # estado global do usuário + banco de emblemas/glossário
    ├── nav.js           # navegação entre abas (Início, Word, Excel, PowerPoint, Downloads)
